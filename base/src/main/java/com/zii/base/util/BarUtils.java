...
/**
 * Description:<br>
 * 包含StatusBar(顶部状态栏)，ActionBar(顶部标题导航栏)，NavigationBar(底部导航栏，即虚拟按键导航栏)三种栏的相关工具方法。
 * <p>
 * 来源：<br>
 * https://github.com/Blankj/AndroidUtilCode/blob/master/utilcode/src/main/java/com/blankj/utilcode/util/BarUtils.java
 * </p>
 * <p> BarUtils Create by Zii at 2018/6/14. </p>
 */
